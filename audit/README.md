...
See [scripts/results.txt](scripts/results.txt) for statistics from the crowdsale contract, generated by the
[scripts/getContractParameters.sh](scripts/getContractParameters.sh) script. The results are periodically updated.
